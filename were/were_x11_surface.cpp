...
were_x11_surface::were_x11_surface(were_pointer<were_x11_compositor> compositor, were_pointer<were_surface> surface) :
    ...
    surface_(surface)
{
    window_ = were1_xcb_window_create(compositor_->display()->get(), 1280, 720);
...
void were_x11_surface::managed()
{
    auto this_wop = were_pointer(this);

    were::connect(compositor_, &were_x11_compositor::event1, this_wop, [this_wop](xcb_generic_event_t *event)
    {
