...
were_surface::were_surface(int width, int height, int format)
{
    MAKE_THIS_WOP

    platform_surface_ = were_platform_surface_provider::default_provider()->create_surface(width, height, format);
